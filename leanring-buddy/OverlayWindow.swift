...
// PreferenceKey for following bubble size
...
struct BlueCursorView: View {
    ...
    /// The rotation angle of the cursor in degrees. The SVG points up-left at 0°.
    ...
    var body: some View {
        ZStack {
            ...
            // Onboarding prompt — screen-aware suggestion streamed after the welcome text
            ...
            // Cursor pointer — shown when idle or while speech is playing (responding).
            ...
            // Blue spinner — shown while the AI is processing (transcription + Codex + waiting for speech)
    ...
    private func startFollowingCursor() {
        timer = Timer.scheduledTimer(withTimeInterval: 0.016, repeats: true) { _ in
            ...
            // During forward navigation or pointing, just skip cursor following
    ...
    private func animateBezierFlightArc(
        ...
        navigationAnimationTimer = Timer.scheduledTimer(withTimeInterval: frameInterval, repeats: true) { _ in
            ...
            // +135° offset because the SVG pointer tip faces up-left at 0° rotation.
    ...
    private func startPointingAtElement() {
        ...
        // Rotate back to the default pointer angle now that we've arrived.
    ...
    private func startFlyingBackToCursor() {
        ...
        let cursorWithFollowingOffset = CGPoint(x: cursorInSwiftUI.x + 35, y: cursorInSwiftUI.y + 25)
        ...
        animateBezierFlightArc(to: cursorWithFollowingOffset) {
        ...
        Timer.scheduledTimer(withTimeInterval: 0.03, repeats: true) { timer in
            guard currentIndex < self.fullWelcomeMessage.count else {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 2.5) {
                    ...
                    self.companionManager.startOnboardingScreenAwarePrompt()
                }
                return
            }
