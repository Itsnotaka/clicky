...
actor CodexAppServerClient {
    ...
    private var threadIDsByDeveloperInstructions: [String: String] = [:]
    ...
    private func ensureThread(
        ...
        if let existingThreadID = threadIDsByDeveloperInstructions[developerInstructions] {
        ...
        threadIDsByDeveloperInstructions[developerInstructions] = threadID
        return threadID
    }
    ...
    private func clearProcessState() {
        ...
        stdoutBuffer = ""
        stderrBuffer = ""
        threadIDsByDeveloperInstructions.removeAll()
    }
